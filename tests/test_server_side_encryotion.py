...
from .common import *
from aliyun_oss_x.models import ServerSideEncryptionRule, PartInfo
from aliyun_oss_x import (
...
class TestSSEDataEncryption(OssTestCase):
    ...
    def test_put_bucket_encryption(self):
        ...
        rule.sse_algorithm = aliyun_oss_x.SERVER_SIDE_ENCRYPTION_SM4
    ...
    def test_put_object_with_encryption(self):
        ...
        sse_algo, data_algo, key_id = self.inner_put_object_with_encryption(
            bucket, object_name, data, SERVER_SIDE_ENCRYPTION_KMS, None
        )
        ...
        sse_algo, data_algo, key_id = self.inner_put_object_with_encryption(
            bucket, object_name, data, SERVER_SIDE_ENCRYPTION_AES256, None
        )
        ...
        sse_algo, data_algo, key_id = self.inner_put_object_with_encryption(
            bucket, object_name, data, SERVER_SIDE_ENCRYPTION_SM4, None
        )
        ...
        sse_algo, data_algo, key_id = self.inner_put_object_with_encryption(
            bucket, object_name, data, SERVER_SIDE_ENCRYPTION_KMS, KMS_DATA_ENCRYPTION_SM4
        )
        self.assertEqual(SERVER_SIDE_ENCRYPTION_KMS, sse_algo)
        ...
        sse_algo, data_algo, key_id = self.inner_put_object_with_encryption(
            bucket, object_name, data, SERVER_SIDE_ENCRYPTION_AES256, KMS_DATA_ENCRYPTION_SM4
        )
        self.assertEqual(SERVER_SIDE_ENCRYPTION_AES256, sse_algo)
        self.assertIsNone(data_algo)
        self.assertIsNone(key_id)
        ...
        sse_algo, data_algo, key_id = self.inner_put_object_with_encryption(
            bucket, object_name, data, SERVER_SIDE_ENCRYPTION_SM4, KMS_DATA_ENCRYPTION_SM4
        )
        self.assertEqual(SERVER_SIDE_ENCRYPTION_SM4, sse_algo)
        self.assertIsNone(data_algo)
        self.assertIsNone(key_id)
        ...
        sse_algo, data_algo, key_id = self.inner_put_object_with_encryption(
            bucket, object_name, data, None, KMS_DATA_ENCRYPTION_SM4
        )
        self.assertIsNone(sse_algo)
        self.assertIsNone(data_algo)
        self.assertIsNone(key_id)
    ...
    def test_append_object_with_encryption(self):
        ...
        sse_algo, data_algo, key_id = self.inner_append_object_with_encryption(
            bucket, object_name, 0, "123", SERVER_SIDE_ENCRYPTION_KMS, None
        )
        self.assertEqual(SERVER_SIDE_ENCRYPTION_KMS, sse_algo)
        self.assertIsNone(data_algo)
        self.assertIsNotNone(key_id)
        ...
        sse_algo, data_algo, key_id = self.inner_append_object_with_encryption(
            bucket, object_name, 3, "456", None, None
        )
        self.assertEqual(SERVER_SIDE_ENCRYPTION_KMS, sse_algo)
        self.assertIsNone(data_algo)
        self.assertIsNotNone(key_id)
        ...
        sse_algo, data_algo, key_id = self.inner_append_object_with_encryption(
            bucket, object_name, 6, "789", SERVER_SIDE_ENCRYPTION_AES256, None
        )
        self.assertEqual(SERVER_SIDE_ENCRYPTION_KMS, sse_algo)
        self.assertIsNone(data_algo)
        self.assertIsNotNone(key_id)
