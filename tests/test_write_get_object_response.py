...
class TestWriteGetObjectResponse(OssTestCase):
    def test_write_get_object_response_normal(self):
        ...
        route = (
            "test-ap-zxl-process-name-43-1283******516515-opap.oss-cn-beijing-internal.oss-object-process.aliyuncs.com"
        )
        ...
        try:
            service = aliyun_oss_x.Service(aliyun_oss_x.Auth(OSS_ID, OSS_SECRET), route)
            ...
            pass
        except aliyun_oss_x.exceptions.ClientError as e2:
            pass
