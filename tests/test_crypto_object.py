...
import aliyun_oss_x
from aliyun_oss_x import http
from aliyun_oss_x import headers
from aliyun_oss_x import RsaProvider
from aliyun_oss_x.compat import to_bytes
from aliyun_oss_x.exceptions import ClientError, NotFound, NoSuchKey
...
class TestCryptoObject(OssTestCase):
    ...
    def test_crypto_bucket_init_user_agent(self):
        ...
        http_headers = None
        http_headers = http.Headers(http_headers)
    ...
    def test_crypto_get_object_with_url_and_process(self):
        ...
        params = {aliyun_oss_x.Bucket.PROCESS: "image/resize,w_100"}
    ...
    def test_copy_crypto_object(self):
        ...
        headers = {"content-md5": aliyun_oss_x.utils.md5_string(content), "content-length": str(len(content))}
    ...
    def test_crypto_object_incorrect_description(self):
        ...
        provider_1 = RsaProvider(
            key_pair={"private_key": private_key_str_1, "public_key": public_key_str_1},
            passphrase=passphrase_1,
            mat_desc=mat_desc_1,
        )
        crypto_bucket_1 = aliyun_oss_x.CryptoBucket(
            aliyun_oss_x.make_auth(OSS_ID, OSS_SECRET),
            OSS_ENDPOINT,
            self.OSS_BUCKET,
            crypto_provider=provider_1,
            region=OSS_REGION,
        )
        ...
        provider_2 = RsaProvider(
            key_pair={"private_key": private_key_str_2, "public_key": public_key_str_2},
            passphrase=passphrase_2,
            mat_desc=mat_desc_2,
        )
        crypto_bucket_2 = aliyun_oss_x.CryptoBucket(
            aliyun_oss_x.make_auth(OSS_ID, OSS_SECRET),
            OSS_ENDPOINT,
            self.OSS_BUCKET,
            crypto_provider=provider_2,
            region=OSS_REGION,
        )
        key = self.random_key(".js")
        content = random_bytes(1024)
        ...
        # 口令未设置
        encryption_materials = aliyun_oss_x.EncryptionMaterials(
            mat_desc_1, key_pair={"private_key": private_key_str_1, "public_key": public_key_str_1}
        )
    ...
    def test_copy_crypto_object_with_replace_meta(self):
        ...
        target_key = key + "_target"
        headers = {'content-md5': aliyun_oss_x.utils.md5_string(content),
    ...
    def test_copy_crypto_object_with_replace_encryption_meta(self):
        ...
        self.assertRaises(aliyun_oss_x.exceptions.InvalidEncryptionRequest, crypto_bucket.copy_object,
