...
class TestBucketDataRedundancyTransition(OssTestCase):
    def test_bucket_data_redundancy_transition_normal(self):
        ...
        self.assertEqual(
            get_result.transition_status, list_user_result.data_redundancy_transitions[0].transition_status
        )
        self.assertEqual(
            get_result.estimated_remaining_time,
            list_user_result.data_redundancy_transitions[0].estimated_remaining_time,
        )
        self.assertEqual(
            get_result.process_percentage, list_user_result.data_redundancy_transitions[0].process_percentage
        )
        ...
        self.assertEqual(
            get_result.transition_status, list_bucket_result.data_redundancy_transitions[0].transition_status
        )
        self.assertEqual(
            get_result.estimated_remaining_time,
            list_bucket_result.data_redundancy_transitions[0].estimated_remaining_time,
        )
        self.assertEqual(
            get_result.process_percentage, list_bucket_result.data_redundancy_transitions[0].process_percentage
        )
