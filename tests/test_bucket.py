...
class TestBucket(OssTestCase):
    def test_bucket(self):
        ...
        bucket = aliyun_oss_x.Bucket(auth, OSS_ENDPOINT, bucket_name)

        bucket.create_bucket(aliyun_oss_x.BUCKET_ACL_PRIVATE)

        service = aliyun_oss_x.Service(auth, OSS_ENDPOINT)
        wait_meta_sync()
        self.retry_assert(
            lambda: bucket.bucket_name in (b.name for b in service.list_buckets(prefix=bucket.bucket_name).buckets)
        )

        key = "a.txt"
        bucket.put_object(key, "content")

        self.assertRaises(aliyun_oss_x.exceptions.BucketNotEmpty, bucket.delete_bucket)

        bucket.delete_object(key)
        bucket.delete_bucket()

        wait_meta_sync()
        self.assertRaises(aliyun_oss_x.exceptions.NoSuchBucket, bucket.delete_bucket)
    ...
    def test_bucket_with_storage_class(self):
        ...
        bucket.create_bucket(
            ...
            aliyun_oss_x.models.BucketCreateConfig(aliyun_oss_x.BUCKET_STORAGE_CLASS_IA),
        )
    ...
    def test_bucket_with_data_redundancy_type(self):
        ...
        # LRS
        bucketConfig = aliyun_oss_x.models.BucketCreateConfig(
            aliyun_oss_x.BUCKET_STORAGE_CLASS_IA, aliyun_oss_x.BUCKET_DATA_REDUNDANCY_TYPE_LRS
        )
        bucket.create_bucket(aliyun_oss_x.BUCKET_ACL_PRIVATE, bucketConfig)
        wait_meta_sync()

        result = bucket.get_bucket_info()
        self.assertEqual(aliyun_oss_x.BUCKET_DATA_REDUNDANCY_TYPE_LRS, result.data_redundancy_type)
        bucket.delete_bucket()

        # ZRS
        if OSS_ENDPOINT.find("oss-cn") != -1:
            bucketConfig = aliyun_oss_x.models.BucketCreateConfig(
                aliyun_oss_x.BUCKET_STORAGE_CLASS_IA, aliyun_oss_x.BUCKET_DATA_REDUNDANCY_TYPE_ZRS
            )
            bucket.create_bucket(aliyun_oss_x.BUCKET_ACL_PRIVATE, bucketConfig)
            wait_meta_sync()

            result = bucket.get_bucket_info()
            self.assertEqual(aliyun_oss_x.BUCKET_DATA_REDUNDANCY_TYPE_ZRS, result.data_redundancy_type)
            bucket.delete_bucket()
    ...
    def test_acl(self):
        ...
        bucket.create_bucket(aliyun_oss_x.BUCKET_ACL_PUBLIC_READ)

        self.retry_assert(lambda: bucket.get_bucket_acl().acl == aliyun_oss_x.BUCKET_ACL_PUBLIC_READ)

        bucket.put_bucket_acl(aliyun_oss_x.BUCKET_ACL_PRIVATE)
        wait_meta_sync()
        self.retry_assert(lambda: bucket.get_bucket_acl().acl == aliyun_oss_x.BUCKET_ACL_PRIVATE)

        bucket.put_bucket_acl(aliyun_oss_x.BUCKET_ACL_PUBLIC_READ_WRITE)
        wait_meta_sync()
        self.retry_assert(lambda: bucket.get_bucket_acl().acl == aliyun_oss_x.BUCKET_ACL_PUBLIC_READ_WRITE)
    ...
    def test_logging(self):
        ...
        other_bucket = aliyun_oss_x.Bucket(self.bucket.auth, OSS_ENDPOINT, bucket_name, region=OSS_REGION)
        other_bucket.create_bucket(aliyun_oss_x.BUCKET_ACL_PRIVATE)
    ...
    def same_lifecycle(orig_rule, bucket):
        ...
        except aliyun_oss_x.exceptions.NoSuchLifecycle:
            return False
    ...
    def test_lifecycle_days(self):
        ...
        for prefix in ["中文前缀+/", "", "中文前缀+/"]:
            rule = LifecycleRule(
                random_string(10), prefix, status=LifecycleRule.ENABLED, expiration=LifecycleExpiration(days=356)
            )
        ...
        self.assertRaises(aliyun_oss_x.exceptions.NoSuchLifecycle, self.bucket.get_bucket_lifecycle)
    ...
    def test_put_lifecycle_days_less_than_transition_days(self):
        ...
        rule = LifecycleRule(
            random_string(10), "中文前缀/", status=LifecycleRule.ENABLED, expiration=LifecycleExpiration(days=3)
        )

        rule.storage_transitions = [
            aliyun_oss_x.models.StorageTransition(days=4, storage_class=aliyun_oss_x.BUCKET_STORAGE_CLASS_IA)
        ]
        self.assertRaises(
            aliyun_oss_x.exceptions.InvalidArgument, self.bucket.put_bucket_lifecycle, BucketLifecycle([rule])
        )
    ...
    def test_put_lifecycle_invalid_transitions(self):
        ...
        rule = LifecycleRule(
            random_string(10), "中文前缀/", status=LifecycleRule.ENABLED, expiration=LifecycleExpiration(days=6)
        )
        # 转储为ARCHIVE的天数小于转储为IA
        rule.storage_transitions = [
            aliyun_oss_x.models.StorageTransition(days=5, storage_class=aliyun_oss_x.BUCKET_STORAGE_CLASS_IA),
            aliyun_oss_x.models.StorageTransition(days=2, storage_class=aliyun_oss_x.BUCKET_STORAGE_CLASS_ARCHIVE),
        ]
        self.assertRaises(
            aliyun_oss_x.exceptions.InvalidArgument, self.bucket.put_bucket_lifecycle, BucketLifecycle([rule])
        )
        ...
        rule.storage_transitions = [
            aliyun_oss_x.models.StorageTransition(days=7, storage_class=aliyun_oss_x.BUCKET_STORAGE_CLASS_IA)
        ]
        self.assertRaises(
            aliyun_oss_x.exceptions.InvalidArgument, self.bucket.put_bucket_lifecycle, BucketLifecycle([rule])
        )
        ...
        # 转储为STANDARD
        rule.storage_transitions = [
            aliyun_oss_x.models.StorageTransition(days=5, storage_class=aliyun_oss_x.BUCKET_STORAGE_CLASS_STANDARD)
        ]
        self.assertRaises(
            aliyun_oss_x.exceptions.InvalidArgument, self.bucket.put_bucket_lifecycle, BucketLifecycle([rule])
        )
    ...
    def test_lifecycle_abort_multipart_upload_days(self):
        from aliyun_oss_x.models import LifecycleExpiration, LifecycleRule, BucketLifecycle, AbortMultipartUpload
    ...
    def test_lifecycle_storage_transitions_mixed(self):
        ...
        rule.storage_transitions = [StorageTransition(days=356, storage_class=aliyun_oss_x.BUCKET_STORAGE_CLASS_IA)]

        lifecycle = BucketLifecycle([rule])

        self.assertRaises(aliyun_oss_x.exceptions.InvalidRequest, self.bucket.put_bucket_lifecycle, lifecycle)
    ...
    def test_lifecycle_storage_transitions_days(self):
        ...
        rule = LifecycleRule(
            random_string(10), "中文前缀/", status=LifecycleRule.ENABLED, expiration=LifecycleExpiration(days=357)
        )
    ...
    def test_lifecycle_storage_transitions_more_days(self):
        ...
        rule.storage_transitions = [
            StorageTransition(days=355, storage_class=aliyun_oss_x.BUCKET_STORAGE_CLASS_IA),
        ...
        self.assertTrue(result.rules[0].tagging is None)
        if result.rules[0].storage_transitions[0].storage_class == aliyun_oss_x.BUCKET_STORAGE_CLASS_IA:
            ...
            self.assertEqual(
                aliyun_oss_x.BUCKET_STORAGE_CLASS_ARCHIVE, result.rules[0].storage_transitions[1].storage_class
            )
        else:
            self.assertEqual(356, result.rules[0].storage_transitions[0].days)
            self.assertEqual(356, result.rules[0].storage_transitions[1].days)
            self.assertEqual(
                aliyun_oss_x.BUCKET_STORAGE_CLASS_IA, result.rules[0].storage_transitions[1].storage_class
            )
        self.bucket.delete_bucket_lifecycle()
    ...
    def test_lifecycle_storage_transitions_date(self):
        ...
        rule.storage_transitions = [
            StorageTransition(
                created_before_date=datetime.date(2016, 12, 25), storage_class=aliyun_oss_x.BUCKET_STORAGE_CLASS_IA
            )
        ]
    ...
    def test_lifecycle_all_without_object_expiration(self):
        from aliyun_oss_x.models import LifecycleRule, BucketLifecycle, AbortMultipartUpload, StorageTransition

        if self.bucket is None:
            raise Exception("bucket is None")

        rule = LifecycleRule(random_string(10), "中文前缀/", status=LifecycleRule.ENABLED)
    ...
    def test_cors(self):
        ...
        cors = aliyun_oss_x.models.BucketCors([rule])
        ...
        self.bucket.delete_bucket_cors()
        wait_meta_sync()
        self.assertRaises(aliyun_oss_x.exceptions.NoSuchCors, self.bucket.get_bucket_cors)
    ...
    def test_bucket_info(self):
        ...
        self.assertEqual(result.storage_class, aliyun_oss_x.BUCKET_STORAGE_CLASS_STANDARD)
        self.assertTrue(len(result.creation_date or "") > 0)
        self.assertTrue(len(result.intranet_endpoint or "") > 0)
        self.assertTrue(len(result.extranet_endpoint or "") > 0)
        self.assertTrue(len(result.owner.id) > 0)
        self.assertEqual(result.acl.grant, aliyun_oss_x.BUCKET_ACL_PRIVATE)
        self.assertIsNotNone(result.data_redundancy_type)
        self.assertIsNotNone(result.comment)
        self.assertEqual(
            result.bucket_encryption_rule.sse_algorithm if result.bucket_encryption_rule else None,
            None,
        )
    ...
    def test_referer(self):
        ...
        config = aliyun_oss_x.models.BucketReferer(True, referers)
    ...
    def test_black_referer(self):
        referers = ["http://hello.com", "mibrowser:home", "中文+referer", "中文+referer"]
        black_referers = ["http://hello2.com", "mibrowser2:home", "中文2+referer", "中文2+referer"]
        allow_empty_referer = True
        allow_truncate_query_string = True

        # black referer 1
        config = aliyun_oss_x.models.BucketReferer(allow_empty_referer, referers, allow_truncate_query_string)
        self.bucket.put_bucket_referer(config)
        wait_meta_sync()
        ...
        config = aliyun_oss_x.models.BucketReferer(
            allow_empty_referer, referers, allow_truncate_query_string, black_referers
        )
        self.bucket.put_bucket_referer(config)
        wait_meta_sync()
        ...
        # black referer 4
        config = aliyun_oss_x.models.BucketReferer(allow_empty_referer, referers, black_referers=[])
        self.bucket.put_bucket_referer(config)
        wait_meta_sync()
    ...
    def test_bucket_encryption_wrong(self):
        from aliyun_oss_x.models import ServerSideEncryptionRule

        self.assertRaises(aliyun_oss_x.exceptions.NoSuchServerSideEncryptionRule, self.bucket.get_bucket_encryption)

        rule = ServerSideEncryptionRule()
        rule.sse_algorithm = aliyun_oss_x.SERVER_SIDE_ENCRYPTION_AES256
        rule.kms_master_keyid = "test"

        self.assertRaises(aliyun_oss_x.exceptions.InvalidArgument, self.bucket.put_bucket_encryption, rule)

        rule.sse_algorithm = "random"
        rule.kms_master_keyid = ""
        self.assertRaises(
            aliyun_oss_x.exceptions.InvalidEncryptionAlgorithmError, self.bucket.put_bucket_encryption, rule
        )

        rule.sse_algorithm = aliyun_oss_x.SERVER_SIDE_ENCRYPTION_KMS
        rule.kms_master_keyid = ""
        ...
        self.assertEqual(result.sse_algorithm, aliyun_oss_x.SERVER_SIDE_ENCRYPTION_KMS)
    ...
    def test_bucket_tagging(self):
        ...
        rule = TaggingRule()
        self.assertRaises(aliyun_oss_x.exceptions.ClientError, rule.add, 129 * "a", "test")
        self.assertRaises(aliyun_oss_x.exceptions.ClientError, rule.add, "test", 257 * "a")
        self.assertRaises(aliyun_oss_x.exceptions.ClientError, rule.add, None, "test")
        self.assertRaises(aliyun_oss_x.exceptions.ClientError, rule.add, "", "test")
    ...
    def test_list_bucket_with_tagging(self):
        ...
        bucket1 = aliyun_oss_x.Bucket(auth, OSS_ENDPOINT, bucket_name1)

        bucket1.create_bucket(aliyun_oss_x.BUCKET_ACL_PRIVATE)

        wait_meta_sync()

        bucket_name2 = self.OSS_BUCKET + "-test-with-tagging-2"
        bucket2 = aliyun_oss_x.Bucket(auth, OSS_ENDPOINT, bucket_name2)

        bucket2.create_bucket(aliyun_oss_x.BUCKET_ACL_PRIVATE)
    ...
    def test_bucket_policy(self):
        ...
        service = aliyun_oss_x.Service(auth, OSS_ENDPOINT)
        wait_meta_sync()
        self.assertRaises(aliyun_oss_x.exceptions.NoSuchBucketPolicy, bucket.get_bucket_policy)
    ...
    def test_bucket_storage_capacity(self):
        auth = aliyun_oss_x.Auth(OSS_ID, OSS_SECRET)
        bucket = aliyun_oss_x.Bucket(auth, OSS_ENDPOINT, random_string(63).lower())
        bucket.create_bucket(aliyun_oss_x.BUCKET_ACL_PRIVATE)
        ...
        user_qos = aliyun_oss_x.models.BucketUserQos(-1)
        bucket.set_bucket_storage_capacity(user_qos)
        result = bucket.get_bucket_storage_capacity()
        self.assertEqual(result.storage_capacity, -1)

        # set neagetive value other than -1
        user_qos = aliyun_oss_x.models.BucketUserQos(-2)
        self.assertRaises(aliyun_oss_x.exceptions.InvalidArgument, bucket.set_bucket_storage_capacity, user_qos)

        # set positive value
        user_qos = aliyun_oss_x.models.BucketUserQos(100)
    ...
    def test_malformed_xml(self):
        ...
        self.assertRaises(aliyun_oss_x.exceptions.MalformedXml, self.bucket.put_bucket_lifecycle, xml_input)

    def test_invalid_argument(self):
        rule = aliyun_oss_x.models.CorsRule(
            allowed_origins=["*"], allowed_methods=["HEAD", "GET"], allowed_headers=["*"], max_age_seconds=-1
        )
        cors = aliyun_oss_x.models.BucketCors([rule])

        try:
            self.bucket.put_bucket_cors(cors)
        except aliyun_oss_x.exceptions.InvalidArgument as e:
    ...
    def test_xml_input_output(self):
        ...
        xml_input2 = """<?xml version="1.0" encoding="UTF-8"?>
                         <RefererConfiguration>
                           <AllowEmptyReferer>true</AllowEmptyReferer>
                           <RefererList>
                             <Referer>阿里云</Referer>
        ...
        for input in [xml_input1, xml_input2]:
            ...
            resp = self.bucket._get_bucket_config(aliyun_oss_x.Bucket.REFERER)
            result = aliyun_oss_x.models.GetBucketRefererResult(resp)
    ...
    def test_bucket_lifecycle_not(self):
        ...
        rule.storage_transitions = [
            StorageTransition(days=355, storage_class=aliyun_oss_x.BUCKET_STORAGE_CLASS_ARCHIVE),
            StorageTransition(days=352, storage_class=aliyun_oss_x.BUCKET_STORAGE_CLASS_IA),
        ]
    ...
    def test_bucket_tagging_with_specify_label(self):
        from aliyun_oss_x.models import Tagging
    ...
    def test_bucket_header_KMS_SM4(self):
        from aliyun_oss_x.headers import (
            ...
            OSS_SERVER_SIDE_ENCRYPTION_KEY_ID,
        ...
        self.assertEqual(aliyun_oss_x.BUCKET_ACL_PUBLIC_READ, bucket_info.acl.grant)
        self.assertEqual(aliyun_oss_x.BUCKET_ACL_PUBLIC_READ, bucket_info.acl.grant)
        bucket.delete_bucket()
        ...
        self.assertEqual(aliyun_oss_x.BUCKET_ACL_PUBLIC_READ_WRITE, bucket_info2.acl.grant)
        self.assertEqual(aliyun_oss_x.BUCKET_STORAGE_CLASS_IA, bucket_info2.storage_class)
        bucket.delete_bucket()
        ...
        headers[OSS_CANNED_ACL] = aliyun_oss_x.BUCKET_ACL_PRIVATE

        bucket.create_bucket(
            aliyun_oss_x.BUCKET_ACL_PUBLIC_READ,
            aliyun_oss_x.models.BucketCreateConfig(aliyun_oss_x.BUCKET_STORAGE_CLASS_IA),
            headers,
        )
        bucket_info3 = bucket.get_bucket_info()

        self.assertEqual(aliyun_oss_x.BUCKET_ACL_PUBLIC_READ, bucket_info3.acl.grant)
        self.assertEqual(aliyun_oss_x.BUCKET_STORAGE_CLASS_IA, bucket_info3.storage_class)
    ...
    def test_bucket_header_SSE_KMS(self):
        from aliyun_oss_x.headers import OSS_SERVER_SIDE_ENCRYPTION, OSS_SERVER_SIDE_ENCRYPTION_KEY_ID
    ...
    def test_bucket_header_SM4(self):
        from aliyun_oss_x.headers import OSS_SERVER_SIDE_ENCRYPTION
    ...
    def test_bucket_path_style(self):
        auth = aliyun_oss_x.Auth(OSS_ID, OSS_SECRET)
        bucket = aliyun_oss_x.Bucket(auth, OSS_ENDPOINT, self.OSS_BUCKET)
        bucket2 = aliyun_oss_x.Bucket(auth, OSS_ENDPOINT, self.OSS_BUCKET, is_path_style=True)

        service = aliyun_oss_x.Service(auth, OSS_ENDPOINT)
        service2 = aliyun_oss_x.Service(auth, OSS_ENDPOINT, is_path_style=True)
    ...
    def test_bucket_stat_param_deep_cold_archive(self):
        auth = aliyun_oss_x.Auth(OSS_ID, OSS_SECRET)
        bucket_name = self.OSS_BUCKET + "-test-stat-deep-cold"
        bucket = aliyun_oss_x.Bucket(auth, OSS_ENDPOINT, bucket_name)
        ...
        self.assertEqual(0, result.cold_archive_real_storage)
        self.assertEqual(0, result.cold_archive_object_count)
        self.assertEqual(0, result.deep_cold_archive_storage)
        self.assertEqual(0, result.deep_cold_archive_real_storage)
        self.assertEqual(0, result.deep_cold_archive_object_count)
