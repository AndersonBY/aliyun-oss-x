...
from .common import *
from aliyun_oss_x.models import UserQosInfo, BucketQosInfo
...
class TestQosInfo(OssTestCase):
    ...
    def test_put_bucket_qos_info_illegal_args(self):
        ...
        self.assertRaises(aliyun_oss_x.exceptions.InvalidArgument, self.bucket.put_bucket_qos_info, bucket_qos_info)
        ...
        if user_qos_info.total_qps > 0:
            ...
            self.assertRaises(
                aliyun_oss_x.exceptions.InvalidArgument, self.bucket.put_bucket_qos_info, bucket_qos_info
            )
