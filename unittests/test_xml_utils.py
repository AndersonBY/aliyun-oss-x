...
from aliyun_oss_x.xml_utils import _find_tag, _find_bool
from aliyun_oss_x.xml_utils import (
...
class TestXmlUtils(unittest.TestCase):
    ...
    def test_parse_get_bucket_info(self):
        ...
        result = aliyun_oss_x.models.GetBucketInfoResult(resp)
  ...
  <Rule>
    ...
    <EncryptionConfiguration>
      <ReplicaKmsKeyID>c2ee80d6-1111-1111-1111-a3644797b566</ReplicaKmsKeyID>
        ...
        result = aliyun_oss_x.models.GetBucketReplicationResult(resp)
  ...
  <LocationTransferTypeConstraint>
    <LocationTransferType>
      ...
      <LocationTransferType>
        ...
        result = aliyun_oss_x.models.GetBucketReplicationLocationResult(resp)
        ...
        self.assertTrue(
            "oss-cn-hongkong"
            in [result.location_transfer_type_list[0].location, result.location_transfer_type_list[1].location]
        )
        self.assertTrue(
            "oss-us-west-1"
            in [result.location_transfer_type_list[0].location, result.location_transfer_type_list[1].location]
 ...
 <Rule>
   ...
   <Progress>
    ...
    <NewObject>2015-09-24T15:28:14.000Z</NewObject>
        ...
        result = aliyun_oss_x.models.GetBucketReplicationProgressResult(resp)
