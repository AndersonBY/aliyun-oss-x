import os
import aliyun_oss_x
from aliyun_oss_x.models import BucketCors, CorsRule
...
rule = CorsRule(allowed_origins=["*"], allowed_methods=["GET", "HEAD"], allowed_headers=["*"], max_age_seconds=1000)
...
except aliyun_oss_x.exceptions.NoSuchCors:
