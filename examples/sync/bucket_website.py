...
condition1 = Condition(
    key_prefix_equals="key1", http_err_code_return_equals=404, include_header_list=[include_header1, include_header2]
)
condition2 = Condition(
    key_prefix_equals="key2", http_err_code_return_equals=404, include_header_list=[include_header1, include_header2]
)
...
include_header2 = ConditionInlcudeHeader("host", "test.oss-cn-shenzhen-internal.aliyuncs.com")
condition1 = Condition(
    key_prefix_equals="key3", http_err_code_return_equals=404, include_header_list=[include_header1, include_header2]
)
condition2 = Condition(
    key_prefix_equals="key4", http_err_code_return_equals=404, include_header_list=[include_header1, include_header2]
)
condition3 = Condition(
    key_prefix_equals="key5", http_err_code_return_equals=404, include_header_list=[include_header1, include_header2]
)
